...
class ConfidenceScorer:
    ...
    def calculate_confidence(self, results: List[EnrichmentResult]) -> Dict[str, Any]:
        """
        ...
        overall_confidence = sum(factors[factor] * self.WEIGHTS[factor] for factor in factors)
    ...
    def _calculate_source_count_score(self, results: List[EnrichmentResult]) -> float:
        """
    ...
    def _calculate_agreement_score(self, results: List[EnrichmentResult]) -> float:
        """
    ...
    def _calculate_reputation_score(self, results: List[EnrichmentResult]) -> float:
        """
        ...
        total_reputation = sum(self.SOURCE_REPUTATION.get(r.source_name, 0.5) for r in results)

        return total_reputation / len(results)

    def _calculate_freshness_score(self, results: List[EnrichmentResult]) -> float:
        """
