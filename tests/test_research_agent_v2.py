...
class TestResearchAgentV2:
    ...
    def test_confidence_scoring(self):
        ...
        state = create_initial_state(intel_text="Malicious IP: 185.220.101.45")
    ...
    def test_enrichment_with_multiple_sources(self):
        ...
        state = create_initial_state(intel_text="IP: 185.220.101.45")
    ...
    def test_intel_with_no_iocs(self):
        ...
        state = create_initial_state(intel_text="This is some text with no indicators.")
